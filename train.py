...
# Debug:
backupdir = '/SSD/fashion-mnist/trash_weights/'
# Normal run
...
# Baseline
model_net = SimpleNet(num_classes)
...
# TEST LOADER
test_loader = torch.utils.data.DataLoader(dataset.fashionDataset(testlist, num_classes=num_classes, shape=(init_width, init_height),
...
def train(epoch):
    ...
    train_loader = torch.utils.data.DataLoader(dataset.fashionDataset(trainlist, num_classes, shape=(init_width, init_height),
